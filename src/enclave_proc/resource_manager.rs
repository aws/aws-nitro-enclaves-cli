...
struct EnclaveStartMetadata {
    /// Context ID (CID) for the enclave vsock device. If 0, the CID is autogenerated.
    enclave_cid: u64,
...
struct ResourceAllocator {
    ...
    region_size: u64,
    /// Maximum number of available regions.
    max_regions: u64,
    /// Actually-allocated regions.
...
impl ResourceAllocator {
    ...
    /// Allocate and provide a list of memory regions.
    ///
...
impl EnclaveHandle {
    ...
    /// Provide parent CPUs to the enclave.
...
impl EnclaveStartMetadata {
    /// Create a new enclave start metadata instance.
...
/// `Duration` representing its value. This is useful for testing purposes.
