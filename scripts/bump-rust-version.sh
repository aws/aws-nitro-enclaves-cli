...
sed -i "s/rust: \[[0-9]\+\.[0-9]\+\.[0-9]\+, stable, nightly\]/rust: [$VERSION, stable, nightly]/" .github/workflows/ci.yml
...
# Update README.md
sed -i "s|^\[msrv\]: https://img.shields.io/badge/MSRV-1.71.1-blue|[msrv]: https://img.shields.io/badge/MSRV-$VERSION-blue|" README.md

# Update tools/Dockerfile
sed -i "s/^ENV RUST_VERSION=[0-9]\+\.[0-9]\+\.[0-9]\+/ENV RUST_VERSION=$VERSION/" tools/Dockerfile
